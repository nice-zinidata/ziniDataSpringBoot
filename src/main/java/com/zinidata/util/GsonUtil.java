...
public class GsonUtil {
    ...
    public String toJson(Object object){
        return BizmapUtil.getSpclStrCnvr(getGsonBuilder().create().toJson(object));
    }
    ...
    public String toJson(JsonOutputVo jsonOutputVo){
        return BizmapUtil.getSpclStrCnvr(getGsonBuilder().create().toJson(messageUtil.setJsonOutputVo(jsonOutputVo)));
    }

    public String toJsonAdm(JsonOutputVo jsonOutputVo){
        return BizmapUtil.escapeCharDecode(BizmapUtil.getSpclStrCnvr(convertJsonAdm(messageUtil.setJsonOutputVo(jsonOutputVo))));
    }
    ...
    public String toJsonCustomMessage(JsonOutputVo jsonOutputVo){
        return BizmapUtil.escapeCharDecode(convertJsonAdm(jsonOutputVo));
    }
