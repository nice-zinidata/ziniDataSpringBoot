...
<div id="sidebar">
    <div class="side-nav" id="member">
        ...
        <div class="side-nav-body">
            <ul>
                <li class="sideMenu on" id="sideMember1" data-url="/bizmapAdmin/member/member1"><button>회원현황</button></li>
                <li class="sideMenu" id="sideMember2" data-url="/bizmapAdmin/member/member2"><button>서비스 신청내역</button></li>
    ...
    <div class="side-nav" id="contents" style="display: none">
        ...
        <div class="side-nav-body">
            <ul>
                <li class="sideMenu on" id="sideContents1" data-url="/bizmapAdmin/contents/contents1"><button>전문가보고서</button></li>
                <li class="sideMenu">창업정보관리</li>
                <li class="sideMenu sub" id="sideContents2" data-url="/bizmapAdmin/contents/contents2"><button>창업뉴스</button></li>
